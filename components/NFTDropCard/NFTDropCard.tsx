...
import { Web3sdksLogo } from "./icons/Web3sdksLogo"
      ...
      <Grid gap={8}>
        ...
        <Grid gap={5}>
          ...
          <Flex
            ...
            align="center"
          >
            <Tooltip label="Powered by web3sdks">
              <IconButton
                aria-label="web3sdks link"
                as="a"
                variant="ghost"
                colorScheme="blackAlpha"
                href="https://web3sdks.com/?utm_source=makeswift"
                target="_blank"
                rel="noreferrer"
              >
                <Web3sdksLogo />
...
const NFTDropCardProvider = forwardRef(function NFTDropCardProvider(
  ...
  return (
    <Web3sdksProvider desiredChainId={Number(chainId)}>
      <ChakraProvider
        theme={extendTheme({
          fonts: {
